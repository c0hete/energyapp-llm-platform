...
- UI ligera servida desde `/static/index.html` (login + chat), con favicon, mensaje de bienvenida, estado “generando…” en streaming, botón de “Login demo (admin)” y accesos rápidos (admin/trabajador/supervisor) que rellenan credenciales de demo.
